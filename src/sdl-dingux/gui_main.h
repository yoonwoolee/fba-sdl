...
#define OPTION_GUI_ROMLIST_CACHE_CLEAR	0
#define OPTION_GUI_DELAYSPEED		1
#define OPTION_GUI_REPEATSPEED	2
#define OPTION_GUI_FILTER			3
#define OPTION_GUI_ROM_PATHS		4
#define OPTION_GUI_DEFAULTS		5
#define OPTION_GUI_SHADOW			6
#define OPTION_GUI_SKIN			7
#define OPTION_GUI_FAV_CLEAR		8
#define OPTION_GUI_RETURN			9

#define OPTION_MAIN_FIRST		OPTION_GUI_ROMLIST_CACHE_CLEAR
